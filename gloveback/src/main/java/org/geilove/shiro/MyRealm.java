package org.geilove.shiro;

/**
 * Created by aihaitao on 18/10/2017.
 */
...
public class MyRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token)
        ...
        if (user != null){
            ...
            AuthenticationInfo authenticationInfo = new SimpleAuthenticationInfo(user.getUserName(),user.getPassword(), "aihaitao") ;
