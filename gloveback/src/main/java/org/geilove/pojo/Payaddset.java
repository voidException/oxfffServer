...
public class Payaddset {
    private Long payaddid;

    private String payadduuid;
    ...
    public Long getPayaddid() {
        return payaddid;
    }

    public void setPayaddid(Long payaddid) {
        this.payaddid = payaddid;
    }

    public String getPayadduuid() {
        return payadduuid;
    }

    public void setPayadduuid(String payadduuid) {
        this.payadduuid = payadduuid == null ? null : payadduuid.trim();
    }
    ...
    public void setMoneystr(String moneystr) {
        this.moneystr = moneystr == null ? null : moneystr.trim();
    }
