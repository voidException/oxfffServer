...
<div id="contain" style="display: flex;flex-direction: column">
    <div class="header">
        <div class="headerItemLeft"  @click="showDefault" style="cursor: pointer">角色列表</div>
    ...
    <div id="default">
        ...
        <template v-for="item in dataRole">
            <div class="mainBodyContain">
                ...
                <div  class="headerBodyBigItem"      style="color: #000; font-size: smaller;cursor: pointer">查看</div>
            </div>
        </template>
    </div>
    <div id="detail" style="display: none">
        <div class="headerBody">
            <div  class="headerBodyBigItem">资源名</div>
            <div  class="headerBodyBigItem">是否拥有</div>
        </div>
        <template v-for="item in dataResource">
            <div class="mainBodyContain">
                <div class="headerBodyBigItem"  style="color: #000;font-size: smaller">{{item.resourcename}}</div>
                <div class="headerBodyBigItem"  style="color: #000;font-size: smaller">
                    <div v-if="item.roleID!=0">
                        <input  v-bind:data-tuserid="item.roleID"  type="checkbox" checked="checkbox">
                    </div>
                    <div v-else>
                        <input   v-bind:data-tuserid="item.roleID"  type="checkbox">
                    </div>
                </div>
            </div>
        </template>
...
<script src="<%=contextPath%>/resources/putaohelp/js/permissionRole.js"></script>
</html>
