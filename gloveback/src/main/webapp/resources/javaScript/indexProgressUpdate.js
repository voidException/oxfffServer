...
new Vue({
    ...
    methods: {
        ...
        test: function (event) {
            //console.log(event.target.attributes[0])
                    ...
                    this.$http.post(publicurl+'/glove/itemprogress/updatelist.do',requestParam).then(response => {
    ...
    mounted: function () {
        ...
        setTimeout(function(){
            that.$http.post(publicurl+'/glove/itemprogress/updatelist.do',param).then(response => {
                //console.log(response.body);
